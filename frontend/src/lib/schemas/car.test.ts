...
describe('color', () => {
  ...
  // 51 символ не влезет в колонку VarChar(50) — отсечь надо здесь,
  // иначе ошибка всплывёт уже в Postgres.
...
describe('mileage', () => {
  ...
  // Раньше пустая строка приводилась к нулю и проходила молча —
  // «не указал» было не отличить от «пробег нулевой».
